                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select 
                            ...
                            <option value="Tingkat Kecamatan Dongko" {{ old('level', $achievement->level) == 'Tingkat Kecamatan Dongko' ? 'selected' : '' }}>Tingkat Kecamatan Dongko</option>
                            <option value="Tingkat Kabupaten Trenggalek" {{ old('level', $achievement->level) == 'Tingkat Kabupaten Trenggalek' ? 'selected' : '' }}>Tingkat Kabupaten Trenggalek</option>
                            <option value="Tingkat Provinsi Jawa Timur" {{ old('level'. $achievement->level) == 'Tingkat Provinsi Jawa Timur' ? 'selected' : '' }}>Tingkat Provinsi Jawa Timur</option>
                            <option value="Tingkat Nasional" {{ old('level', $achievement->level) == 'Tingkat Nasional' ? 'selected' : '' }}>Tingkat Nasional</option>
                            <option value="Tingkat Internasional" {{ old('level', $achievement->level) == 'Tingkat Internasional' ? 'selected' : '' }}>Tingkat Internasional</option>
                        </select>
