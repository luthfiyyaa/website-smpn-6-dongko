...
<div class="mb-8">
    ...
    <p class="text-[var(--color-neutral-700)]">Fill in the details to create a new news article</p>
</div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <textarea 
                    ...
                    required
                    class="w-full px-4 py-3 border border-[var(--color-neutral-300)] rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] focus:border-transparent"
                    placeholder="Brief summary of the article (shown in previews)">{{ old('excerpt') }}</textarea>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <textarea 
                    ...
                    required
                    class="w-full px-4 py-3 border border-[var(--color-neutral-300)] rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] focus:border-transparent"
                    placeholder="Write the full article content here...">{{ old('content') }}</textarea>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="mb-4">
                    <label class="flex items-center gap-3 cursor-pointer">
                        ...
                        <span class="text-[var(--color-neutral-900)]">Publish immediately</span>
                    </label>
